      ...
      <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
        <div className="text-center py-12">
          ...
          <p className="text-slate-600 mb-8">
            Track and manage your golf rounds here.
          </p>
          <div className="inline-flex items-center gap-2 rounded-lg bg-blue-50 px-4 py-2 text-blue-700 border border-blue-200">
